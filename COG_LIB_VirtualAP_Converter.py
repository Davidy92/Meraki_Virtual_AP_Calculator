...
#load workbook
workbook = xlsxwriter.Workbook('COG_LIB_Network.xlsx')
...
def writer(name, physical_mac, entry_24, entry_5):
    ...
    if SSID_FORMAT == 2:
        worksheet.write(SSID_COUNTER, 3, "COG_INTSYS")
    if SSID_FORMAT == 3:
        worksheet.write(SSID_COUNTER, 3, "COG_STAFF")
    if SSID_FORMAT == 4:
        worksheet.write(SSID_COUNTER, 3, "COG_GUEST")
    if SSID_FORMAT == 5:
        worksheet.write(SSID_COUNTER, 3, "ISD_TEST")
    if SSID_FORMAT == 6:
        worksheet.write(SSID_COUNTER, 3, "GV_PATRON")
    if SSID_FORMAT == 7:
        worksheet.write(SSID_COUNTER, 3, "VSO")
    if SSID_FORMAT == 8:
        worksheet.write(SSID_COUNTER, 3, "AS_PATRON")
    if SSID_FORMAT == 9:
        worksheet.write(SSID_COUNTER, 3, "BLIB_PATRON")
    if SSID_FORMAT == 10:
        worksheet.write(SSID_COUNTER, 3, "ML_PATRON")
    if SSID_FORMAT == 11:
        worksheet.write(SSID_COUNTER, 3, "CV_PATRON")
    if SSID_FORMAT == 12:
        worksheet.write(SSID_COUNTER, 3, "PLIB_PATRON")
    if SSID_FORMAT == 13:
        worksheet.write(SSID_COUNTER, 3, "CC_PATRON")
    if SSID_FORMAT == 14:
        worksheet.write(SSID_COUNTER, 3, "Library Net")
    if SSID_FORMAT == 15:
        worksheet.write(SSID_COUNTER, 3, "MedixSafe AP")
